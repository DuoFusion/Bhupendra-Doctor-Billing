  ...
  return (
    <div className="rounded-2xl bg-[#0b172a]/90 ring-1 ring-white/5">
      <div className="px-6 py-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            ...
            >
              <option value="asc">Role: Admin to User</option>
              <option value="desc">Role: User to Admin</option>
            </select>
      ...
      <div className="sm:hidden p-4 space-y-4">
        {usersList?.length > 0 ? (
          usersList.map((user: any) => (
            <div key={user._id} className="rounded-xl bg-[#0b172a]/95 p-4 ring-1 ring-white/5">
